    ...
    private fun launchDaemon() {
        ...
        val command = """
            ...
            : > "${'$'}LOG"
            {
              ...
              echo "[vessel-launch] exec runtime daemon protocol 5"
              exec python ~/vessel-poc-runtime/tools/venus_poc/vessel_runtime_daemon_v5.py
            } >> "${'$'}LOG" 2>&1
        """.trimIndent()
