...
class TermuxUmlController(private val context: Context) {
    companion object {
        ...
        const val REQUIRED_PROTOCOL = 13
    ...
    private fun launchDaemon() {
        ...
        val command = """
            ...
            : > "${'$'}LOG"
            {
              ...
              echo "[vessel-launch] exec runtime daemon protocol 13"
              exec python ~/vessel-poc-runtime/tools/venus_poc/vessel_runtime_daemon_v13.py
            } >> "${'$'}LOG" 2>&1
        """.trimIndent()
