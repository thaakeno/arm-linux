...
class TermuxUmlController(private val context: Context) {
    companion object {
        ...
        const val REQUIRED_PROTOCOL = 15
    ...
    private fun launchDaemon() {
        ...
        val command = """
            ...
            : > "${'$'}LOG"
            {
              ...
              echo "[vessel-launch] exec runtime daemon protocol 15"
              exec python ~/vessel-poc-runtime/tools/venus_poc/vessel_runtime_daemon_v15.py
            } >> "${'$'}LOG" 2>&1
        """.trimIndent()
