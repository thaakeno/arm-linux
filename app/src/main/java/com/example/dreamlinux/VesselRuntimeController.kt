...
class VesselRuntimeController(
    ...
    override val backendId: String = "uml"
    override val backendLabel: String = "UML"
    override val runtimeRevision: String get() = REVISION
    override val displayTransport: String get() = DISPLAY_TRANSPORT
    ...
    override val machineDir: File = File(context.filesDir, "vessel-machine").apply { mkdirs() }
    private val disk = File(machineDir, "debian-docker.ext4")
    private val persistentLog = File(machineDir, "vessel-runtime.log")

    override val guestMemoryMb: Int by lazy {
    ...
    override val selectedVcpus: Int
    ...
    override fun hasStorageAccess(): Boolean = machineDir.isDirectory || machineDir.mkdirs()
    ...
    override fun hostAssetsReady(): Boolean = runtimeFiles().all { it.isFile && it.length() > 0L }
    ...
    override suspend fun resizeDesktop(width: Int, height: Int, dpi: Int, refresh: Float): Boolean = withContext(Dispatchers.IO) {
    ...
    private fun launchDesktop() {
        ...
        val prep = """
            ...
            FUSER
            sed -i -e '/security\\.sandbox\\.content\\.level/d' -e '/gl\\.require-hardware/d' /home/vessel/.mozilla/firefox/vessel.default/prefs.js 2>/dev/null || true
    ...
    override suspend fun guest(command: String, timeoutSeconds: Int): JSONObject = withContext(Dispatchers.IO) {
