...
python3 - "$SCRIPT_DIR/apply_umshm.py" "$SMP_UMSHM_PATCHER" <<'PY'
...
python3 "$SCRIPT_DIR/fix_umshm_nonblock.py" "$SRC"
python3 "$SCRIPT_DIR/fix_umshm_ptrace_fds.py" "$SRC"
python3 "$SCRIPT_DIR/patch_virtio_uml_vhost_gpu.py" "$SRC"
